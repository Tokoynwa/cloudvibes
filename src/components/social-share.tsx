  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-1.5 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors text-sm"
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors text-sm"
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-1.5 bg-slate-600 hover:bg-slate-700 text-white rounded-lg transition-colors text-sm"
